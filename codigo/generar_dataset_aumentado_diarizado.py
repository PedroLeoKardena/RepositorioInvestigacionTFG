...
def expandir_metadata_aumentada(ruta_base):
    ...
    try:
        ...
        print("Error: No se encontraron los archivos metadata chunked diarizados.")
        return
    ...
    def expandir_df(df_original, listado_sufijos):
        ...
        for _, row in df_original.iterrows():
            nombre_base = str(row['nombre_archivo']).rsplit('.', 1)[0]
    ...
    df_train_aug.to_csv(ruta_entrenamiento / "metadata_train_aumentado_diarizado.csv", index=False, sep=";")
    df_test_aug.to_csv(ruta_entrenamiento / "metadata_test_aumentado_diarizado.csv", index=False, sep=";")
...
if __name__ == "__main__":
    ...
    print("--- 1. GENERANDO ARCHIVOS DE AUDIO AUMENTADOS DIARIZADOS ---")
