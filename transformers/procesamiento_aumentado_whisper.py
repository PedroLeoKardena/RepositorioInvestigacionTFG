...
class WhisperAugmentedPipeline(BaseTransformerPipeline):
    @property
    ...
    @property
    def nombre_run(self): return f"Whisper_Chunk_Augmented_{EPOCHS}epochs"
    @property
    def nombre_modelo_guardado(self): return "modelo_multitask_augmented_whisper"
...
if __name__ == "__main__":
    ...
    pipeline = WhisperAugmentedPipeline()
    pipeline.ejecutar()
