...
def entrenar_modelo():
    ...
    for fold_val in range(5):
        ...
        training_args_cv = TrainingArguments(
            output_dir=str(ruta_modelos / f"hubert_aumentado_diarizado_fold_{fold_val}"),
    ...
    training_args_final = TrainingArguments(
        output_dir=str(ruta_modelos / "entrenamiento_final_hubert_aumentado_diarizado"),
    ...
    ruta_guardado_final = ruta_modelos / "modelo_multitask_augmented_hubert_diarizado"
