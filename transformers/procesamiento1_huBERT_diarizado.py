...
def entrenar_modelo():
    ...
    for fold_val in range(5):
        ...
        training_args_cv = TrainingArguments(
            output_dir=str(ruta_modelos / f"hubert_diarizado_fold_{fold_val}"),
    ...
    training_args_final = TrainingArguments(
        output_dir=str(ruta_modelos / "entrenamiento_final_hubert_diarizado"),
    ...
    ruta_guardado_final = ruta_modelos / "modelo_multitask_hubert_diarizado"
